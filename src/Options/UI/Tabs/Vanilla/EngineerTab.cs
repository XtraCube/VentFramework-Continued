...
public sealed class EngineerTab: VanillaTab
{
    public static EngineerTab Instance = null!;
    ...
    public override void Setup(RolesSettingsMenu menu)
    {
        ...
        roleCategory = GameManager.Instance.GameSettingsList.AllRoles.ToArray().Where(cat => cat.Role.Role == AmongUs.GameOptions.RoleTypes.Engineer).First();
