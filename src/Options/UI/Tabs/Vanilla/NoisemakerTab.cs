...
public sealed class NoisemakerTab: VanillaTab
{
    public static NoisemakerTab Instance = null!;
    ...
    public override void Setup(RolesSettingsMenu menu)
    {
        ...
        roleCategory = GameManager.Instance.GameSettingsList.AllRoles.ToArray().Where(cat => cat.Role.Role == AmongUs.GameOptions.RoleTypes.Noisemaker).First();
