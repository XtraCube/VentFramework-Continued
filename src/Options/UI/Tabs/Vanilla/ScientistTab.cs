...
public sealed class ScientistTab: VanillaTab
{
    public static ScientistTab Instance = null!;
    ...
    public override void Setup(RolesSettingsMenu menu)
    {
        ...
        roleCategory = GameManager.Instance.GameSettingsList.AllRoles.ToArray().Where(cat => cat.Role.Role == AmongUs.GameOptions.RoleTypes.Scientist).First();
