...
public sealed class DetectiveTab: VanillaTab
{
    public static DetectiveTab Instance = null!;
    ...
    public override void Setup(RolesSettingsMenu menu)
    {
        ...
        roleBehaviour = DestroyableSingleton<RoleManager>.Instance.GetRole(RoleTypes.Detective);
